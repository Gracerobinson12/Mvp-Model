...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // 2. Check admin FIRST — using maybeSingle so no error if not found
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        body::before{content:'';position:fixed;inset:0;background:radial-gradient(ellipse 70% 50% at 15% 10%,rgba(255,59,48,0.07) 0%,transparent 60%),linear-gradient(160deg,#f5f4f9 0%,#eceaf2 40%,#f2f0f7 100%);pointer-events:none;z-index:0}
      ...
      <div style={{position:'relative',zIndex:1,minHeight:'100vh',
        ...
        <div style={{flex:1,display:'flex',alignItems:'center',
          ...
          <div style={{
            ...
            boxShadow:'0 4px 24px rgba(0,0,0,.07),inset 0 1px 0 rgba(255,255,255,1)',
            ...
            <div style={{marginBottom:24}}>
              <div style={{display:'flex',justifyContent:'space-between',
                ...
                <a href="/reset-password" style={{fontSize:12,color:'#ff3b30',
            ...
            {error && (
              <div style={{background:'rgba(255,59,48,.07)',
        ...
        {/* Footer */}
        <div style={{padding:'20px 32px',display:'flex',
